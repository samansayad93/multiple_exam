...
namespace AzmoonGir
{
    public partial class FrmUser : Form
    {
        ...
        public void GrdView()
        {
            SqlDataAdapter da = new SqlDataAdapter("SelectAllUser", con);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("کاربر جدید با موفقیت اضافه گردید");
                    GrdView();
        ...
        private void GrdUser_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            TxtUsername.Text = GrdUser.CurrentRow.Cells["username"].Value.ToString();
            TxtPassword.Text = GrdUser.CurrentRow.Cells["password"].Value.ToString();
            TxtUsername.Focus();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                MessageBox.Show("کلمه عبور کاربر مورد نظر تغییر کرد");
                GrdView();
                TxtUsername.Enabled = true;
                btnAdd.Enabled = true;
                btnEdit.Enabled = false;
